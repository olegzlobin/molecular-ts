...
export const russianLocale: LocalePack = {
  ...
  messages: {
    ...
    Start: 'Старт',
    Stop: 'Стоп',
    'Genomes handled:': 'Обработано геномов:',
    '(stopping...)': '(остановка...)',
    ...
    'Macro config': 'Макроконфиг',
    'Population size': 'Размер популяции',
    'Survival rate': 'Доля выживания',
    ...
    'Weight of relative filtered compounds count': 'Вес относительного числа отфильтрованных соединений',
    'Weight of relative clustered compounds count': 'Вес относительного числа кластеризованных соединений',
    'Weight of relative clustered atoms count': 'Вес относительного числа кластеризованных атомов',
    ...
    'Weight of symmetry grade of clustered compounds': 'Вес степени симметрии кластеризованных соединений',
    ...
    'Weight of relative compounded atoms count': 'Вес относительного числа связанных атомов',
