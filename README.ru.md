...
Миры можно импортировать и экспортировать как файлы конфигурации и состояния. В приложении доступен генетический поиск
для исследования конфигураций типов, порождающих более структурированные соединения.
